      ...
      13695: (e, t, s) => {
        ...
        class ue {
          ...
          buildInterface() {
            ...
            ((this.score = this.createNew("div", t)),
              ...
              (this.speedText.style.transform = "translateY(-80%)"),
              ...
              if (a.hasOwnProperty(e)) {
                ...
                for (let a = 0; a < o; a++) {
                  ...
                  if (o.length > 2) {
                    ...
                    const t = this.randKey(ye.sys.legend[e], true);
          ...
          checkJoysticks(e) {
            ...
            if (
              ...
              if (((this.last = n), n))
                ...
                else Ae.sys.routeInput(n, true, false);
              return n;
            }
          }
          checkButtons(e) {
            ...
            if (t(e.buttons[4]) && t(e.buttons[5]))
              return (
                ...
                void (this.linkedPad.pressed.rb = true)
              );
            let s;
        ...
        class Pe {
          ...
          onMouseMove(e) {
            if (te.sys.session.state === Q.Play) {
              ...
              this.mousePos !== t &&
                ((this.mousePos = t), Ae.sys.routeInput(t, true, false));
            }
          }
          onContextMenu(e) {
            e.preventDefault();
        ...
        class ze extends ve {
          ...
          boost(e = false) {
            ...
            // Apply boost effects
            this.dist.boost = 4000; // boost duration
          ...
          spin() {
            ...
            switch (this.dir) {
              case "downright":
              case "right":
                this.changeDirection(e ? "left" : "downleft", true);
                break;
              case "downleft":
              case "left":
                this.changeDirection(e ? "right" : "downright", true);
                break;
              default:
          ...
          collectLife() {
            ...
            // Only increase lives if below max
            if (game.lives.current < game.lives.max) {
              game.lives.current += 1;
              ue.sys.refreshDisplay();
            }
        ...
        class Oe {
          ...
          onTouchMove(e) {
            ...
            if (
              ...
              this.touchPos !== e &&
                ((this.touchPos = e), Ae.sys.routeInput(e, true, false));
            }
          }
          onTouchEnd(e) {
            if (this.interact(e)) return;
          ...
          interact(e) {
            ...
            return (
              ...
              (e.cancelable && e.preventDefault(), false)
            );
          }
        }
      ...
      42999: (e, t, s) => {
        ...
        class g extends i.Z {
          ...
          static isValidSelectedItem(e) {
            return (
              void 0 !== e &&
              true !== e.props[g.disabledPropertyKey] &&
          ...
          constructor(e) {
            (super(e),
              ...
              (this.checkPropsForMenuState = () => {
                ...
                return (
                  void 0 !== this.props.isMenuOpen
                    ...
                    : true === this.props.multiselectable && (e = true),
                  e
                );
              }),
              ...
              (this.trimSelection = (e) =>
                false === this.props.multiselectable && e.length > 1
              ...
              (this.validateMenuState = (e) => {
                ...
                return (
                  void 0 !== this.props.isMenuOpen
                    ...
                    : true === this.props.multiselectable && (t = true),
                  t
                );
              }),
    ...
    (i.O = (t, s, a, o) => {
      if (!s) {
        ...
        for (h = 0; h < e.length; h++) {
          for (var [s, a, o] = e[h], r = true, l = 0; l < s.length; l++)
            (false & o || n >= o) && Object.keys(i.O).every((e) => i.O[e](s[l]))
              ? s.splice(l--, 1)
              : ((r = false), o < n && (n = o));
          r && (e.splice(h--, 1), (t = a()));
        }
